...
/** Svarta band över och under innehållet – högre på liggande datorskärmar. */
const letterbox = "h-[14svh] shrink-0 bg-black wide:h-[18svh]";
...
export default async function HomePage() {
  ...
  return (
    <>
      {/* Helsida med svarta band över och under (bredbildskänsla) */}
      <div className="flex min-h-svh flex-col bg-white print:hidden">
        <div aria-hidden="true" className={letterbox} />

        {/* Logotyp, tagline och QR-koder samlade mitt på sidan */}
      ...
      <section aria-hidden="true" className={printCard}>
        <div className="text-center">
          ...
          <p className="mt-[2.5cqw] whitespace-nowrap text-[2.1cqw] uppercase tracking-[0.12em]">
            {site.tagline}
          </p>
        </div>
      </section>
